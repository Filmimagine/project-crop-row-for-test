...
from utils.general import LOGGER,check_img_size, check_requirements, check_imshow, non_max_suppression, apply_classifier, \
...
def detect(save_img=False):
    ...
    save_img = not opt.nosave and (not isinstance(source, str) or not source.endswith('.txt'))  # save inference images
